...
<html>
    ...
    <body>
        ...
        <c:url var="addUrl" value="/loaidienthoai/themsp"></c:url>
       ...
       <nav class="navbar navbar-expand-lg back bg-dark">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col pt-2">
                    <form:form method="POST" modelAttribute="loaidienthoai" action="${addUrl}" accept-charset="UTF-8">

                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <form:hidden path="maLoai" class="form-control" />
                            </div>
                        </div>

                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="inputTen">Tên loại điện thoại</label>
                                <form:input path="tenLoai" class="form-control" id="inputTen" required="required"/>
                            </div>
                        </div>
