...
<html>
    ...
    <body>
        ...
        <c:url var="addUrl" value="/dienthoai/themsp">
        </c:url>        
        <c:url var="addNSXUrl" value="/nhasanxuat/showFormThem">
        </c:url>
        <c:url var="addLoaiMayUrl" value="/loaidienthoai/showFormThem">
        </c:url>
                    ...
                    <form:form modelAttribute="dienthoai" method="POST" action="${addUrl}" enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <a href="${addLoaiMayUrl}" class="link-primary">Thêm loại điện thoại</a>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <a href="${addNSXUrl}" class="link-primary">Thêm nhà sản xuất</a>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <form:select path="mauSac" id="inputMauSac" class="form-control">
                        ...
                        <div class="form-row">
                            ...
                            <form:input path="doPhanGiai" class="form-control" id="inputDoPhanGiai" required="required"  />
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <form:input path="giaNhap" onblur="validate_giaNhap()" class="form-control" id="GiaNhap" required="required"/>
                            </div>
                            <div class="form-group col-md-2">
                                <label for="inputGiaBan">Giá bán</label>
                                <form:input path="giaBan" onblur="validate_giaBan()" class="form-control" id="inputGiaBan" required="required"/>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <form:select path="xuatXu" id="inputXuatXu" class="form-control">
