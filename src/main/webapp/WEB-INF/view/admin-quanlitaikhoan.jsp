                    ...
                    <table class="table">
                        ...
                        <th></th>
                            ...
                            <tr>
                                ...
                                <td>${kh.ten}</td>
                                <td>${kh.email}</td>
                                <c:url var="xemchitiet" value="/admin/xemchitiettk" >
                                    <c:param name="maKh" value="${kh.maKh}"></c:param>
                                </c:url>
                                <c:url var="xoatk" value="/admin/xoatk" >
                                    <c:param name="maKh" value="${kh.maKh}"></c:param>
                                </c:url> 
                                <td><a href="${xemchitiet}" class="text-success">Xem chi tiết</a></td>
                                <td><a href="${xoatk}" class="text-danger">Xóa</a></td>
                            </tr>
                        </c:forEach>
                    </table>
